...
import win from "images/astronaut.svg";
...
const StarIcon = tw(StarIconBase)`inline-block w-5 h-5 text-green-100 fill-current mr-1 last:mr-0`;
...
export default ({
  ...
  imageBorder = false,
  imageShadow = false,
  subheading = "Testemunhos",
  heading = "Nossos clientes Sabem",
  description = "Possuimos clientes nas mais diversas áreas. Conheça relatos reais de nossos queridos clientes",
  textOnLeft = false,
  testimonials = [
    {
      stars: 5,
